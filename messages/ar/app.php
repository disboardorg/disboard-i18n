...
return [
    ...
    'Showing <b>{from}</b> - <b>{to}</b> of <strong>{total} servers</strong>' => 'يتم عرض <b>{from}</b> - <b>{to}</b> من <strong>{total} servers</strong>',
    'Showing <b>{from}</b> - <b>{to}</b> of <strong>{total} reviews</strong>' => 'يتم عرض <b>{from}</b> - <b>{to}</b> من <strong>{total} reviews</strong>',
    'Sort by' => 'مرتبة بحسب',
    'Submit' => 'إرسال',
    'Support' => 'الدعم',
