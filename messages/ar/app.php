...
return [
    ...
    'Why don\'t you review your favorite <span class="discord-logo">Discord</span> server?' => 'لماذا لا تعطي رأيك عن سيرفر <span class="discord-logo">Discord</span> المفضل لك؟',
    'Why don\'t you <a href="{reviewUrl}">review <strong>{serverName}</strong></a>?' => 'لماذاا لا <a href="{reviewUrl}">تعطي رأيك <strong>{serverName}</strong></a>؟',
