...
return [
    ...
    'All Discord reviews' => 'Alle Discord Rezensionen',
    'All Discord servers' => 'Alle Discord Server',
    ...
    'Cancel' => 'Abbrechen',
    'Categorize your server by keywords (e.g. game title)' => 'Kategorisiere deinen Server mit Stichworten (z.B. Spieltitel)',
    'Category' => 'Kategorie',
    ...
    'Discord Servers Bumped Recently' => 'Kürzlich gebumpte Discord Servers',
    'Discord servers categorized as <strong>{category}</strong>' => 'Discord Servers aus der Kategorie <strong>{category}</strong>',
    'Discord servers tagged with {tag}' => 'Liste der Discord Servers mit dem Stichwort {tag}',
    '<span class="discord-logo">Discord</span> Servers' => '<span class="discord-logo">Discord</span> Servers',
    'Discord servers tagged with <strong>{tag}</strong>' => 'Discord Servers mit dem Stichwort <strong>{tag}</strong>',
    ...
    'Muted servers' => 'Stummgeschaltete Servers',
    ...
    'Private' => 'Privat',
    'Public' => 'Öffentlich',
    'Public Discord Servers' => 'Öffentliche Discord Servers',
    ...
    'Report Description' => 'Beschreibung melden',
    ...
    'Select a server to add to the public server list on DISBOARD' => 'Wähle einen Server aus, um ihn zur öffentlichen Serverliste von Disboard hinzuzufügen',
    ...
    'This server has been removed due to breaking our guidelines' => 'Dieser Server wurde aufgrund eines Verstoßes gegen unsere Richtlinien entfernt',
    ...
    '<b>{total}</b> servers in total' => '<b>{total}</b> Servers insgesamt',
    ...
    'Want to be a partner?' => 'Möchtest du Partner werden?',
    ...
    'You haven\'t added a server yet' => 'Du hast bisher noch keinen Server hinzugefügt.',
    'You must be logged in to mute a server' => 'Du musst eingeloggt sein, um einen Server stummzuschalten.',
    'You must be a member of the server to review it' => 'Du musst ein Mitglied des Servers sein, um ihn zu bewerten',
    'You need to be in the server for at least {duration} days to review' => 'Du musst für mindestens {duration} Tage in diesem Server sein, um ihn zu bewerten',
    ...
    'DISBOARD was made to make everyone enjoy Discord more.<br>We hope you find awesome Discord servers and friends here 😊.' => 'DISBOARD ist gemacht worden, damit alle Discord mehr genießen können.<br>Wir hoffen, du findest hier tolle Discord Server und Freunde 😊.',
    /* Rules, ToS */
    'Name or description contains insult or swear words' => 'Der Name oder die Beschreibung enthält Beleidigungen oder Fluchwörter',
    ...
    'Discover <span class="discord-logo">Discord</span> Servers' => 'Entdecke <span class="discord-logo">Discord</span> Servers',
    'We connect <strong>Discord servers</strong> and <b>people</b> together' => 'Wir verbinden <strong>Discord Servers</strong> und <b>Personen</b>',
    '<strong class="brand">DISBOARD</strong> is the place where you can <strong>list/find Discord servers</strong>.' => '<strong class="brand">DISBOARD</strong> ist der Ort, an dem du <strong>Discord Server aufführen/finden</strong> kannst.',
    'Find and join some awesome servers listed here.' => 'Finde und trete ein paar tollen Servern bei, die hier aufgeführt sind.',
    ...
    /* Meta Descriptions */
    'DISBOARD is the public Discord server listing community. You can search Discord servers by your interest like Gaming, Anime, Music, etc. Find and join some awesome servers listed here!' => 'DISBOARD ist eine öffentliche Discord Serverliste. Du kannst Discord Server nach deinen Interessen suchen, wie Gaming, Anime, Musik etc. Finde tolle Server, die hier aufgeführt sind und tritt ihnen bei!',
    'Search results for: {keyword}. There {count, plural, =1{is # server which is} other{are # servers which are}} waiting for your joining!' => 'Suchergebnisse für: {keyword}. Es gibt {count, plural, =1{# Server, der} other{# Servers, die}} darauf warten, dass du beitrittst!',
    'List of Discord servers tagged with {tag}. Find and join some awesome servers listed here!' => 'Liste von Discord Servern mit dem Stichwort {tag}. Finde tolle Servers, die hier gelistet sind und tritt ihnen bei!',
];
