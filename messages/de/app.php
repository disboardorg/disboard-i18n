...
return [
    ...
    'Add <b>CREATE_INSTANT_INVITE</b> permission to DISBOARD bot.' => 'Gebe dem DISBOARD Bot die <b>Einladung erstellen</b> und <b>Nachrichten senden</b> Berechtigungen.',
    'Admin response' => 'Antwort eines Administrators',
    'Admin servers' => 'Administrierte Server',
    'After that send this command: <span class="tag is-light">/invite</span>' => 'Nutze dann den Befehl: <span class="tag is-light">/invite</span>',
    ...
    'Send the invite command: `/invite #channel`' => 'Schicke den Einladungsbefehl: `/invite #channel`',
    ...
    'This server is currently under review.' => 'Dieser Server wird derzeit überprüft',
    'This server has been approved. Edit and publish it from Dashboard!' => 'Dieser Server wurde genehmigt. Bearbeiten und veröffentlichen Sie ihn über das Dashboard!',
    ...
    'Top active Discord servers' => 'Die aktivsten Discord-Server',
    ...
    'Your server listing wasn\'t accepted. Please review your server details and try submitting it again.' => 'Ihre Serverauflistung wurde nicht akzeptiert. Bitte überprüfen Sie Ihre Serverdetails und versuchen Sie erneut, sie einzureichen.',
    ...
    'This page may contain adult content.' => 'Diese Seite kann Inhalte für Erwachsene enthalten.',
    'By accessing this page, you confirm that you are of legal age in your country of residence and agree to view adult content.' => 'Durch den Zugriff auf diese Seite bestätigen Sie, dass Sie im Land Ihres Wohnsitzes volljährig sind und damit einverstanden sind, Inhalte für Erwachsene anzusehen.',
    'Yes, I\'m over 18' => 'Ja, ich bin über 18',
];
