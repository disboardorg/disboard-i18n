...
return [
    ...
    'Add Bot' => 'Dodaj bota',
    'Add a Tag' => 'Dodaj tag',
    'Add <b>CREATE_INSTANT_INVITE</b> permission to DISBOARD bot.' => 'Dodaj botowi DISBOARD następujące uprawnienia: <b>Tworzenie zaproszenia</b>, <b>Wysyłanie wiadomości</b>.',
    'Admin response' => 'Odpowiedź administratora',
    'Admin servers' => 'Serwery na których jesteś administratorem',
    'After that send this command: <span class="tag is-light">/invite</span>' => 'Potem wpisz komendę <span class="tag is-light">/invite</span> na serwerze.',
	...
	'Send the invite command: `/invite #channel`' => 'Wpisz komendę `/invite #kanał`, aby utworzyć zaproszenie do kanału',
	'Separate by <b>space</b>' => 'Rozdziel <b>spacją</b>',
    'Settings' => 'Ustawienia',
    'Servers' => 'Serwery',
    'Server admin?' => 'Jesteś administratorem serwera?',
    'Server Language' => 'Język serwera',
    ...
    'This server is currently under review.' => 'Ten serwer jest obecnie w trakcie przeglądu',
    'This server has been approved. Edit and publish it from Dashboard!' => 'Ten serwer został zatwierdzony. Edytuj i opublikuj go z pulpitu!',
    ...
    'Top active Discord servers' => 'Najbardziej aktywne serwery Discord',
    ...
    'Your server listing wasn\'t accepted. Please review your server details and try submitting it again.' => 'Twoje ogłoszenie serwera nie zostało zaakceptowane. Proszę przejrzeć szczegóły serwera i spróbować przesłać je ponownie.',
    ...
    'This page may contain adult content.' => 'Ta strona może zawierać treści dla dorosłych.',
    'By accessing this page, you confirm that you are of legal age in your country of residence and agree to view adult content.' => 'Uzyskując dostęp do tej strony, potwierdzasz, że jesteś pełnoletni w swoim kraju zamieszkania i zgadzasz się na oglądanie treści dla dorosłych.',
    'Yes, I\'m over 18' => 'Tak, mam ponad 18 lat',
];
