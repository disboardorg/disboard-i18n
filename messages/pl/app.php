...
return [
    ...
    'Partners' => 'Partnerzy',
    'Please check the checkbox below before joining "<strong>{serverName}</strong>"' => 'Przed dołączeniem na "<strong>{serverName}</strong>" zaznacz poniższe pole wyboru',
    ...
    'Please wait another {0, plural, =1{# minute} other{# minutes}} until you can bump' => 'Poczekaj jeszcze {0} minut, zanim będziesz mógł podbić serwer',
