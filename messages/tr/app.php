...
return [
    ...
    'Are you sure you want to delete {serverName}?' => '{serverName} adli sunucu silmekte emin misin?',
    'Are you sure you want to delete this review?' => 'Bu elestiriyi silmekte emin misin?',
    ...
    'Could not bump the server because the invite link is invalid (expired?)' => 'Davet linki gecersiz (suresi dolmus?) olduiu icin bu sunucu patlatilamadi',
    ...
    'Don\'t forget to check "Set this link to never expire"' => '"Bu bailantiyi hicbir zaman sona ermeyecek sekilde ayarla" seceneiini isaretlemeyi unutmayin',
    'Edit' => 'Duzenle',
    ...
    'If your server isn\'t in the above list or dropdown, sync with Discord manually' => 'Eier sunucunuz yukaridaki listede veya acilan listede deiilse, manual olarak discord ile senkronize et',
    'You can now write reviews and add ratings for servers you are joining.<br>Let\'s recommend your favorite servers to other people!' => 'Artik elestri yazabilir ve girdiiin sunuculari derecelendirebilirsin.<br>Hadi, diier insanlara senin favori sunucularini oner.',
    ...
    'Official verified partners' => 'Orijinal Onayli Ortaklar',
    'Owner servers' => 'Kurucu sunuculari',
    'Partners' => 'Ortaklar',
    'Please check the checkbox below before joining "<strong>{serverName}</strong>"' => 'Lutfen asaiidaki onay kutusunu girmeden once kontrol et "<strong>{serverName}</strong>"',
    ...
    'Servers' => 'Sunucular',
    'Server admin?' => 'Sunucu yoneticisi?',
