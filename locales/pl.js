{
  ...
  "This!": "To, co widzisz!",
  "Bump this server": "Podbij reklamę tego serwera",
  "Get server page link": "Uzyskaj link do strony serwera",
  "Change Instant Invite to this channel. If [channel] is specified, create Instant Invite for that channel": "Ustaw, aby zaproszenie kierowało do tego kanału. Jeśli określono kanał [channel], utwórz niewygasające zaproszenie dla tego kanału (dostępne tylko dla administratorów)",
  "Admin only": "Tylko dla administratorów",
  "Bump done": "Podbito reklamę",
