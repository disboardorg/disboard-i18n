{
  ...
  "Change Instant Invite to this channel. If [channel] is specified, create Instant Invite for that channel": "招待リンクをこのチャンネルに変更するよ。もし[channel]が指定されたら、そのチャンネルに招待を作成するよ。",
  "Admin only": "管理者のみ",
